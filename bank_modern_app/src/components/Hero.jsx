...
const Hero = () => {
  return (
    <section id="home" className={`flex md:flex-row flex-col sm:px-16 px-6`}>
      <div
      ...
      <div className="flex-1 flex justify-center items-center">
        ...
        <div className="absolute z-[1] w-[80%] h-[80%] rounded-full bottom-40 white__gradient overflow-hidden" />
